...
subroutine get_cwf(charge)
  ...
  real(kind=id)::xx,eta,ki,bess_wp,tmp
...
!$omp private(r,p,arg,wp,fc,gc,fcp,gcp,sig,ifail,kfn,tmp)&
...
!$omp schedule(dynamic)collapse(2)
  do ir=1,meshr
    ...
    if(arg.gt.1.e-7_id)then
       call coul90(arg,-charge/p,0._id,lmax_t+1,fc(0:lmax_t+1),gc(0:lmax_t+1),fcp(0:lmax_t+1),gcp(0:lmax_t+1),kfn,ifail)
    else
      fc(0)=sqrt(2._id*pi*p/(1._id-exp(-2._id*pi/p)))
      do l=1,lmax_t
        fc(l)=fc(l-1)*p*sqrt(l*l+1._id/p/p)/real(l*(2*l+1),id)
      enddo
      do l=0,lmax_t
       tmp=r**l*(1 - r/(1 + l) + ((2 - p**2 - l*p**2)*r**2)/(2.*(1 + l)*(3 + 2*l)) + &
 &    ((-2 + 4*p**2 + 3*l*p**2)*r**3)/(6.*(1 + l)*(2 + l)*(3 + 2*l)) + &
 &    ((4 - 20*p**2 - 12*l*p**2 + 6*p**4 + 9*l*p**4 + 3*l**2*p**4)*r**4)/ &
 &     (24.*(1 + l)*(2 + l)*(3 + 2*l)*(5 + 2*l)) + &
 &    ((-4 + 40*p**2 + 20*l*p**2 - 46*p**4 - 55*l*p**4 - 15*l**2*p**4)*r**5)/ &
 &     (120.*(1 + l)*(2 + l)*(3 + l)*(3 + 2*l)*(5 + 2*l)) + &
 &    ((8 - 140*p**2 - 60*l*p**2 + 392*p**4 + 390*l*p**4 + 90*l**2*p**4 - 90*p**6 - &
 &         165*l*p**6 - 90*l**2*p**6 - 15*l**3*p**6)*r**6)/ &
 &     (720.*(1 + l)*(2 + l)*(3 + l)*(3 + 2*l)*(5 + 2*l)*(7 + 2*l)) + &
 &    ((-8 + 224*p**2 + 84*l*p**2 - 1232*p**4 - 1050*l*p**4 - 210*l**2*p**4 + &
 &         1056*p**6 + 1596*l*p**6 + 735*l**2*p**6 + 105*l**3*p**6)*r**7)/ &
 &     (5040.*(1 + l)*(2 + l)*(3 + l)*(4 + l)*(3 + 2*l)*(5 + 2*l)*(7 + 2*l)) + &
 &    ((16 - 672*p**2 - 224*l*p**2 + 6384*p**4 + 4760*l*p**4 + 840*l**2*p**4 - &
 &         13088*p**6 - 16856*l*p**6 - 6720*l**2*p**6 - 840*l**3*p**6 + 2520*p**8 + &
 &         5250*l*p**8 + 3675*l**2*p**8 + 1050*l**3*p**8 + 105*l**4*p**8)*r**8)/&
 &     (40320.*(1 + l)*(2 + l)*(3 + l)*(4 + l)*(3 + 2*l)*(5 + 2*l)*(7 + 2*l)*(9+ 2*l)))
        fc(l)=fc(l)*tmp*r
      enddo
    endif
